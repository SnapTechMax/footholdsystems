 ...
 * separate so copy can be edited and reviewed without touching plumbing.
 *
 ...
 * passing, later ones lead with the ask. The `ask` field on each email is the
 * dial, and the tiers are roughly:
 *
 ...
 * No em-dashes anywhere, including &mdash; entities. Assume a busy owner
 * reading on a phone between jobs.
 */
...
const emails = [
  ...
  },
  {
    key: "cost",
    delay: "2 days",
    subject: "What this actually costs",
    cta: "Book a call",
    body: [
      p("Hi {{{FIRST_NAME}}},"),
      p("Fair question, and most people in this industry are cagey about it, so here it is plainly."),
      p("I charge a flat fee, agreed up front, for a written plan. You keep the plan whether or not you go further with me. If you do go ahead within 30 days, that fee comes off the build."),
      p("The build itself gets quoted once we both know what it is. I cannot price it before that, and anyone who does is guessing."),
      p("What I will not do is put you on a monthly retainer for something you did not need."),
    ],
    ask: "The twenty minute call is free and there is no version of it where I invoice you for it. Book it and find out what your number is.",
  },
  {
    key: "data",
    delay: "2 days",
