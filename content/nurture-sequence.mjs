...
const emails = [
  ...
  },
  {
    ...
    body: [
      ...
      p("The second domain has one audience. It exists at the exact place models go looking, structured the exact way they want, saying the things about you they need in order to recommend you, with none of the compromises. It does not have to look like anything. It has to be findable and unambiguous."),
      p("Your main site gets fixed. The second one gets built to do the job properly."),
      p(`${UPGRADE_PRICE}, once, not a retainer. Two to three weeks. You keep everything, both domains and a written record of what changed and why, so if you never speak to me again the next person can pick it up.`),
      p("What it is not: a guarantee that ChatGPT will recommend you. Nobody controls a model's output, and anybody telling you otherwise is selling you something. What I control is every input it uses."),
    ],
